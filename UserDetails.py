...
def app():
    ...
    if st.session_state['Start'] == 0:
        ...
        with ShowContainer:
            ...
            st.session_state['Age']st.session_state['Age'] = st.text_input('Enter Your Age')
            st.session_state['UPPeople']st.session_state['UPPeople'] = st.selectbox('Are you from Uttar Pradesh', ['Yes', 'No'])
