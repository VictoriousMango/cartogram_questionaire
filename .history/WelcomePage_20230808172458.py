...
def app():
    ...
    if st.session_state['Proceed'] == 0:
        ...
        st.markdown("<h5 style='text-align: center; color: black;'>Cartogram is a Thematic map of a set of features (countries, provinces, etc.), in which their geographic size is altered which is directly proportional to a selected ratio-level variable, such as travel time, population, or GNP. </h5>", unsafe_allow_html=True)
        ...
        st.markdown("<h6 style='text-align: center; color: grey;'>                                                   You can take <b color: black;>BREAK<b> in every section</h6>", unsafe_allow_html=True)
