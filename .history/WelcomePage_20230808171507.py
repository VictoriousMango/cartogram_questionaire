...
def app():
    ...
    if st.session_state['Proceed'] == 0:
        #with ph.contianer():
        st.markdown("<h1 style='text-align: center; color: black;'> Welcome to Map Evaluation Portal </h1>", unsafe_allow_html=True)
        ...
        st.markdown("<h6 style='text-align: center; color: grey;'>Cartogram is a Thematic map of a set of features (countries, provinces, etc.), in which their geographic size is altered which is directly proportional to a selected ratio-level variable, such as travel time, population, or GNP. </h6>", unsafe_allow_html=True)
