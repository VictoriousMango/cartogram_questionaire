...
import StreamlitApplication.Apps_L1.QuizGiver as QuizGiver
import StreamlitApplication.Apps_L1.QuizTaker as QuizTaker
import StreamlitApplication.Apps_L1.ImageImporter as ImgImport
import time
    ...
    if Finish:
      ...
      with st.sidebar:
        ...
        with open("Database.txt", "a") as db:
          ...
          db.write(Name)
          db.write(json.dumps(Ans, indent=4))
        #db = {Name : Ans}
